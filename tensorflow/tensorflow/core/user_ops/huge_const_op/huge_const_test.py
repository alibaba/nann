...
#  with tf.device("/CPU:0"):
  ...
  a0 = tf.huge_const(path="huge0.npy", dtype = tf.int32, shape = (3,2))
  a1 = tf.huge_const(path="huge1.npy", dtype = tf.int64, shape = (2,3))
  a2 = tf.huge_const(path="huge2.npy", dtype = tf.float32, shape = (1,6))
