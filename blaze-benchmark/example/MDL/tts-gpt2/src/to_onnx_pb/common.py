...
#autoinit conflicts with pytorch set_device when using multiprocess
...
def allocate_buffers(engine):
    ...
    for binding in engine:
        ...
        if engine.binding_is_input(binding):
          size = 256 * engine.max_batch_size
          size = 256 * 4 * 1 * 2 + 256*256*4
        else:
          size = 256 * 256 * engine.max_batch_size
          size = 256 * 30000 * 4
